...
<nav class="navbar navbar-expand-lg main-navbar" style="left:3px !important">
  <div class="form-inline mr-auto">
    <h4 class="navbar-brand ml-3">OSCE UMSU</h4>
  </div>
  <ul class="navbar-nav navbar-right">
    <li class="dropdown">
      <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
        <div class="d-sm-none d-lg-inline-block"><?= session()->get('lokasiNama') ?> | <?= session()->get('stationNama') ?></div>
      </a>
      <div class="dropdown-menu dropdown-menu-right">
        <a href="<?= site_url('/penilaianLogout') ?>" class="dropdown-item has-icon text-danger">

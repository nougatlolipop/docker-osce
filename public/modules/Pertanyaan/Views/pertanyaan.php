                                            ...
                                            foreach ($pertanyaan as $lks) : ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:center">
                                                        <button class="btn btn-icon icon-left btn-info" onclick="<?= 'getPertanyaan(' . $lks->setId . ')' ?>"><i class="fas fa-question"></i> Set Pertanyaan</button>
                                                        <button class="btn btn-icon icon-left btn-success" onclick="<?= 'getCetakPertanyaan(' . $lks->setId . ')' ?>"><i class="fas fa-print"></i> Cetak Pertanyaan</button>
                                                    </td>
                                                </tr>
                                            <?php endforeach ?>
                                        <?php else : ?>
...
<!-- start modal edit  -->
<div class="modal fade" role="dialog" id="editPertanyaan">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <input type="hidden" name="bobotMax" value="<?= getNilaiMax() ?>">
            <form id="pertanyaan" action="" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
...
<!-- start modal detail  -->
<?php foreach ($pertanyaan as $detail) : ?>
